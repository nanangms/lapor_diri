...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('kelurahan.create') }}" class="btn btn-info pull-right modal-show" style="margin-top: -8px;" title="Tambah Kelurahan"><i class="fa fa-plus"></i> Tambah</a>
        <hr class="invisible">
...
<script>
    $('#datatable').DataTable({
        ...
        columns: [
            ...
            {data: 'kecamatan', name: 'nama_kecamatan'},
