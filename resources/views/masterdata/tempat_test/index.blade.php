        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tempat test</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Tempat test</h3>
        ...
        <div class="card-body">
            <a href="{{ route('tempat_test.create') }}" class="btn btn-info pull-right modal-show" style="margin-top: -8px;" title="Tambah Tempat test"><i class="fa fa-plus"></i> Tambah</a>
        <hr class="invisible">
            <table id="datatable" class="table table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Tempat test</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
