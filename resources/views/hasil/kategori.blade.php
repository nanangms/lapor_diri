...
@section('title')
Hasil Gowes Kategori : {{$kategori_jarak}} Km
@endsection
@section('header')
<!-- DataTables -->
...
<div class="content-wrapper">
    ...
    <a href="/hasil_gowes" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">

            <h1>Hasil Gowes Kategori : {{$kategori_jarak}} Km</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="/hasil_gowes">Hasil Gowes</a></li>
              <li class="breadcrumb-item active">Hasil Gowes Kategori : {{$kategori_jarak}} Km</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Hasil Gowes Kategori : {{$kategori_jarak}} Km</h3>
        ...
        <div class="card-body">
            ...
            @if(Request::segment(2)== '08')
                <a href="/print-submit-gowes/08" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 08 Km</a>

                <a href="/excel-submit-gowes/08" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 08 Km</a>
            @elseif(Request::segment(2)== '17')
                <a href="/print-submit-gowes/17" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 17 Km</a>

                <a href="/excel-submit-gowes/17" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 17 Km</a>
            @elseif(Request::segment(2)== '28')
                <a href="/print-submit-gowes/28" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 28 Km</a>

                <a href="/excel-submit-gowes/28" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 28 Km</a>
            @elseif(Request::segment(2)== '75')
                <a href="/print-submit-gowes/75" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 75 Km</a>

                <a href="/excel-submit-gowes/75" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 75 Km</a>
            @elseif(Request::segment(2)== '45')
                <a href="/print-submit-gowes/45" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 45 Km</a>

                <a href="/excel-submit-gowes/45" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 45 Km</a>
            @elseif(Request::segment(2)== '76')
                <a href="/print-submit-gowes/76" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak 76 Km</a>

                <a href="/excel-submit-gowes/76" target="_blank" class="btn btn-success"><i class="fa fa-file-excel"></i> Cetak 76 Km</a>
            @endif
...
<script>
    ...
    $('#table_id').DataTable({
        ...
        pageLength: 1000,
        serverSide: true,
        ajax:"{{url('getdatalaporankategori')}}/"+id,
        columns: [
